        ...
        function initBanner(){
            ...
            $.ajax({
                ...
                success: function (obj) {
                    ...
                    StonefontTemp += "万";
                    //电影图片
                    avatar.append("<img class=\"avatar\" src=\"" + obj.data.moviePoster + "\" alt=\"\">");
                    movieBriefContainer.append(
                        "<h3 class=\"name\">" + obj.data.movieName + "</h3>" +
                        "<div class=\"ename ellipsis\">" + obj.data.movieForeignName + "</div>" +
                        "<ul>" +
                            "<li class=\"ellipsis\">" + obj.data.movieTypes + "</li>" +
                            "<li class=\"ellipsis\">" + obj.data.movieLength + " / " + obj.data.movieRegion + "</li>" +
                            "<li class=\"ellipsis\">" + obj.data.movieLanguage + "</li>" +
                            "<li class=\"ellipsis\">" + obj.data.movieRelease + "</li>" +

                        "<ul>");
                    //分数
                    infoNum.append("<span class=\"stonefont\">" + obj.data.movieScore + "</span>");
                    //评论
                    scoreNum.append("<span class=\"stonefont\">" + obj.data.movieCommentNum + "</span>人评分");
                    //票房
                    stonefontNum.append("<span class=\"stonefont\">" + StonefontTemp + "</span>");
                    actionBuyBtn.append("<div class=\"moviedetail\"></div>");
                    Introduction.append(
                        "<div class=\"mod-content\">" +
                        "<span class=\"dra\" style=\"font-size:16px;\">" + obj.data.movieIntroduction + "</span>" +
                        "</div>"
                    );
                    ...
                    ,yes: function(){
                        ...
                        $.ajax({
                            ...
                            success:function (obj) {
                                //code=0就说明添加成功了
                                if(obj.code == 0){
                                    layer.alert('感谢您的评价,祝您生活愉快！',{icon: 0,offset: clientHeight/5},
                                        function (){
                                            layer.closeAll();
                                            location.reload();
                                        }
                                    ...
                                    //否则失败
                                    layer.alert('评分失败！',{icon: 0,offset: clientHeight/5},
                                        function (){
                                            layer.closeAll();
                                            location.reload();
                                        }
        ...
        function intitActor(){
            ...
            $.ajax({
                ...
                success:function (obj) {
                    console.log(obj);
                    //生成导演的图片路径
                    PictureUrl = "../static/images/actor/" + obj.data.movieName + "/director/" + obj.data.movieDirector + ".jpg";
                    // 导演
                    ...
                    for(var i = 0;i<StrActor.length;i++){
                        ...
                        //演员的图片地址
                        PictureUrl = "../static/images/actor/" + obj.data.movieName + "/actor/" + StrRole[0] + ".jpg";
                        // 演员
                        PosName="&nbsp";
                        if(i==0){
                            PosName = "演职人员";
